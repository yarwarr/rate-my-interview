    ...
    google: (props: LucideProps) => (
     ...
     github : (props: LucideProps) => (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          <path
            fill="#181717"
            d="M12 .297C5.373.297.297 5.373.297 12c0 4.914 3.184 9.08 7.605 10.557.555.102.757-.24.757-.533v-1.865C5.137 21.037 4.5 19.979 4.5 19.979c-1.106-1.855-.287-3.315-.287-3.315-1.149-1.623.084-1.59.084-1.59 1.272.09 1.943 1.305 1.943 1.305 1.13 1.932 2.965 1.375 3.686 1.053.114-.827.439-1.384.8-1.703-2.807-.314-5.751-1.404-5.751-6.244 0-1.378.491-2.502 1.305-3.384-.131-.313-.57-1.692.125-3.524 0 0 1.116-.358 3.655 1.363a12.236 12.236 0 0 1 3.186-.429c1.08.006 2.168.145 3.186.429 2.538-1.721 3.65-1.363 3.65-1.363.695 1.832.257 3.211.125 3.524.814.882 1.303 2.006 1.303 3.384 0 4.85-2.948 5.924-5.764 6.232.453.391.856 1.162.856 2.342v3.454c0 .295.201.639.768.532C20.817 21.075 24 16.909 24 12c0-6.627-5.373-11.703-11.703-11.703z"
          />
        </svg>
      ),
